...
async function buildComprehensive() {
    ...
    teams['ATM'] = {
        ...
        players: [
            { id: 'atm_1', name: 'Jan Oblak', webName: 'Oblak', pos: 'GK', club: 'ATM', price: 5.7, number: 13, form: 5.8, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p102046.png', goals: 0, assists: 0, cleanSheets: 10, saves: 54 },
            { id: 'atm_2', name: 'José María Giménez', webName: 'Giménez', pos: 'DEF', club: 'ATM', price: 5.2, number: 2, form: 5.3, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p155823.png', goals: 1, assists: 0, cleanSheets: 9, saves: 0 },
            { id: 'atm_3', name: 'Robin Le Normand', webName: 'Le Normand', pos: 'DEF', club: 'ATM', price: 5.0, number: 24, form: 5.1, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p243566.png', goals: 0, assists: 0, cleanSheets: 8, saves: 0 },
            { id: 'atm_4', name: 'Antoine Griezmann', webName: 'Griezmann', pos: 'MID', club: 'ATM', price: 9.0, number: 7, form: 7.6, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p80254.png', goals: 7, assists: 7, cleanSheets: 9, saves: 0 },
            { id: 'atm_5', name: 'Rodrigo De Paul', webName: 'De Paul', pos: 'MID', club: 'ATM', price: 6.2, number: 5, form: 5.5, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p155825.png', goals: 2, assists: 3, cleanSheets: 8, saves: 0 },
            { id: 'atm_6', name: 'Conor Gallagher', webName: 'Gallagher', pos: 'MID', club: 'ATM', price: 6.0, number: 4, form: 5.4, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p232787.png', goals: 3, assists: 1, cleanSheets: 7, saves: 0 },
            { id: 'atm_7', name: 'Julián Alvarez', webName: 'J.Alvarez', pos: 'FWD', club: 'ATM', price: 9.4, number: 19, form: 7.7, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p461358.png', goals: 8, assists: 4, cleanSheets: 8, saves: 0 },
            { id: 'atm_8', name: 'Alexander Sørloth', webName: 'Sørloth', pos: 'FWD', club: 'ATM', price: 7.6, number: 9, form: 6.1, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p171834.png', goals: 6, assists: 2, cleanSheets: 6, saves: 0 }
        ]
    };
    ...
    teams['SEV'] = {
        ...
        players: [
            { id: 'sev_1', name: 'Ørjan Nyland', webName: 'Nyland', pos: 'GK', club: 'SEV', price: 4.8, number: 13, form: 4.5, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p117042.png', goals: 0, assists: 0, cleanSheets: 5, saves: 42 },
            { id: 'sev_2', name: 'Loïc Badé', webName: 'Badé', pos: 'DEF', club: 'SEV', price: 4.9, number: 22, form: 4.7, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p443743.png', goals: 1, assists: 0, cleanSheets: 6, saves: 0 },
            { id: 'sev_3', name: 'Saúl Ñíguez', webName: 'Saúl', pos: 'MID', club: 'SEV', price: 5.5, number: 17, form: 5.0, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p111490.png', goals: 2, assists: 2, cleanSheets: 5, saves: 0 },
            { id: 'sev_4', name: 'Dodi Lukebakio', webName: 'Lukebakio', pos: 'MID', club: 'SEV', price: 6.2, number: 11, form: 6.1, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p217482.png', goals: 5, assists: 2, cleanSheets: 4, saves: 0 },
            { id: 'sev_5', name: 'Isaac Romero', webName: 'Isaac', pos: 'FWD', club: 'SEV', price: 5.8, number: 20, form: 5.2, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p544837.png', goals: 3, assists: 2, cleanSheets: 4, saves: 0 }
        ]
    };
    ...
    teams['ATH'] = {
        ...
        players: [
            { id: 'ath_1', name: 'Unai Simón', webName: 'Simón', pos: 'GK', club: 'ATH', price: 5.5, number: 1, form: 5.8, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p194765.png', goals: 0, assists: 0, cleanSheets: 9, saves: 48 },
            { id: 'ath_2', name: 'Dani Vivian', webName: 'Vivian', pos: 'DEF', club: 'ATH', price: 5.1, number: 3, form: 5.4, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p443744.png', goals: 1, assists: 0, cleanSheets: 8, saves: 0 },
            { id: 'ath_3', name: 'Nico Williams', webName: 'Nico W.', pos: 'MID', club: 'ATH', price: 8.5, number: 10, form: 7.9, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p493106.png', goals: 6, assists: 8, cleanSheets: 8, saves: 0 },
            { id: 'ath_4', name: 'Oihan Sancet', webName: 'Sancet', pos: 'MID', club: 'ATH', price: 6.8, number: 8, form: 6.8, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p443745.png', goals: 7, assists: 3, cleanSheets: 7, saves: 0 },
            { id: 'ath_5', name: 'Iñaki Williams', webName: 'Iñaki W.', pos: 'FWD', club: 'ATH', price: 7.4, number: 9, form: 6.7, photo: 'https://resources.premierleague.com/premierleague/photos/players/250x250/p184980.png', goals: 7, assists: 5, cleanSheets: 7, saves: 0 }
        ]
    };
